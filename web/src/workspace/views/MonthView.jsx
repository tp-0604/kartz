...
import { AllianceChip, Delta, Empty, ScoreCell, Sparkline, Stats, useSort } from '../../components/shared/ui.jsx';
  ...
  return (
    <div className="viewpane stack">
      <div className="viewpane__head">
        <h2>Month across days</h2>
        <span className="hint">One row per player, a column per scoring day — the shape the old
          workbook had, with growth worked out here rather than kept in step by hand.</span>
      </div>
      <div className="row">
        <div className="field">
