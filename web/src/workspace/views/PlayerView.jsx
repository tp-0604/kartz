...
import { AllianceChip, Delta, Empty, RankDelta, ScoreCell, Sparkline, Stats } from '../../components/shared/ui.jsx';
  ...
  return (
    <div className="viewpane stack">
      <div className="viewpane__head">
        <h2>One player over time</h2>
        <span className="hint">Every board a player appears on — the question a spreadsheet tab
          cannot answer.</span>
      </div>
      <div className="row">
